...
export const routes: Routes = [
  ...
  { path: 'lic-products', component: LicProductsComponent, canActivate: [authGuard], data: { roles: ['admin', 'lic'] } },
  { path: 'lic-premium-calculator', component: LicPremiumCalculatorComponent, canActivate: [authGuard], data: { roles: ['admin', 'lic'] } },
  ...
  { path: 'policies', component: PoliciesComponent, canActivate: [authGuard], data: { roles: ['admin', 'lic'] } },
