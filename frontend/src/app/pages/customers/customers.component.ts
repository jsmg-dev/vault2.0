...
export class CustomersComponent implements OnInit, OnDestroy {
  ...
  openCreateCustomerModal() {
    console.log('Opening create customer modal - Customer Code field should NOT be visible');
  ...
  async createCustomer(event: Event) {
    ...
    try {
      console.log('Creating customer without customer_code input...');
      ...
      if (res.ok) {
        ...
        const customerCode = result.customer_code || 'N/A';
        const customerId = result.customer_id || 'N/A';
        this.toastService.success(`Customer created successfully! Code: ${customerCode}, ID: ${customerId}`);
  ...
  async updateCustomer(event: Event) {
    ...
    const formData = new FormData();
    // Customer code cannot be changed during edit
  ...
  downloadTemplate() {
    ...
    const csvContent = 'Name,Customer Code,Phone,Email,Address,Status,Date of Birth,Gender,Occupation,Monthly Income,Loan Amount,Interest Rate,Loan Tenure,EMI Amount,Guarantor Name,Guarantor Phone,Guarantor Address\n' +
                      'John Doe,CUST001,9876543210,john@example.com,123 Main St,Active,1990-01-15,Male,Engineer,50000,100000,12,12,8884.88,Jane Smith,9876543211,456 Oak Ave\n' +
                      'Jane Smith,CUST002,9876543212,jane@example.com,456 Oak St,Active,1985-05-20,Female,Teacher,40000,80000,10,24,3691.94,Bob Johnson,9876543213,789 Pine St\n' +
                      'Bob Johnson,CUST003,9876543214,bob@example.com,789 Pine St,Active,1988-12-10,Male,Doctor,80000,150000,8,36,4707.35,Alice Brown,9876543215,321 Elm St';
